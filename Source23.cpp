...
//					cout << "Добро пожаловать в игру!\t Информация о последнем ходе:\n";
//					cout << "Сейчас ход: " << color_player1 << player_name1 << C_WHITE << "\t\t Игрок: " << color_player2 << "Bot_Askhab" << C_WHITE << " ход на клетку: " << C_GRAY << xod << C_WHITE << "\n\n";
//				}
...
//				else if (q % 2 == 0 and comp == 1) {
//					cout << "Добро пожаловать в игру!\t Информация о последнем ходе:\n";
//					cout << "Сейчас ход: " << color_player2 << "Bot_Askhab" << C_WHITE << "\t\t Игрок: " << color_player1 << player_name1 << C_WHITE << " ход на клетку: " << C_GRAY << xod << C_WHITE << "\n\n";
//				}
//				int x = 0, v = 0;
//				for (int i = 0; i < 5; i++) {
//					cout << "\t"; \
...
//
//				}
//				cout << "\nВведите номер клетки куда хотите поставить свой символ:\n";
//				if (q % 2 != 0) {
//					key3 = _getch();
//				}
//				else if (q % 2 == 0 and comp == 1) {
...
//						}
//						else if (comp == 1) {
//							cout << "Проиграл\nКомп " << color_player2 << "Bot_Askhab" << C_WHITE << "\nПотерял 6 очков\n\n";
...
//					}
//					else {
//						cout << "Комп: " << C_WHITE << "Bot_Askhab" << C_WHITE;
//						cout << "\nПотерял 1 очко\n\n";
